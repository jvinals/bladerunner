          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col justify-center self-stretch rounded-lg border border-gray-100 bg-white px-2 py-0.5 shadow-sm lg:min-w-[min(100%,30rem)] lg:flex-[1.2]">
            ...
            >
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-1.5 border border-gray-200 text-gray-600 text-[11px] font-medium rounded-md hover:border-[#4B90FF] hover:text-[#4B90FF] transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:border-gray-200 disabled:hover:text-gray-600"
              >
              ...
              {isPlaying && isPaused ? (
                <button
                  ...
                  className="flex shrink-0 items-center gap-1 px-2 py-1.5 border border-emerald-200 text-emerald-700 text-[11px] font-medium rounded-md hover:bg-emerald-50 transition-colors"
                ...
                <button
                  ...
                  className="flex shrink-0 items-center gap-1 px-2 py-1.5 border border-amber-200 text-amber-800 text-[11px] font-medium rounded-md hover:bg-amber-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:border-gray-100 disabled:text-gray-400 disabled:hover:bg-transparent"
                  title={
              ...
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-1.5 border border-red-200 text-red-600 text-[11px] font-medium rounded-md hover:bg-red-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                title={
                  !canPauseOrStopDuringPlayback
                    ? 'Wait until automatic Clerk sign-in has finished'
                    : 'Stop playback'
              ...
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-1.5 border border-slate-200 text-slate-700 text-[11px] font-medium rounded-md hover:bg-slate-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              ...
              <button
                ...
                className="flex w-36 shrink-0 justify-center items-center gap-1 px-2 py-1.5 border border-indigo-200 text-indigo-800 text-[11px] font-medium rounded-md hover:bg-indigo-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              ...
              <input
                ...
                disabled={!isPlaying || !isPaused}
                className="w-12 shrink-0 rounded border border-gray-200 px-1.5 py-1.5 text-[11px] text-gray-800 tabular-nums bg-white disabled:opacity-50"
              ...
              <button
                ...
                className="shrink-0 rounded border border-violet-200 px-2 py-1.5 text-[11px] font-medium text-violet-800 hover:bg-violet-50 disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Go
              </button>
              <button
