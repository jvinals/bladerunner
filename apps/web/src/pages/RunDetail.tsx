    ...
    <div className="flex-1 min-h-0 w-full max-w-none overflow-y-auto py-8 px-6 lg:px-10">
      ...
      <div className="space-y-2 mb-6">
        <div className="flex flex-col gap-2 lg:flex-row lg:items-stretch lg:gap-3">
          <div className="flex min-h-0 min-w-0 flex-1 flex-col justify-center self-stretch rounded-lg border border-gray-100 bg-white px-2 py-0 shadow-sm lg:min-w-[min(100%,30rem)] lg:flex-[1.2]">
            ...
            >
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-0 border border-gray-200 text-gray-600 text-[11px] font-medium leading-none rounded-md hover:border-[#4B90FF] hover:text-[#4B90FF] transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:border-gray-200 disabled:hover:text-gray-600"
              >
              ...
              {isPlaying && isPaused ? (
                <button
                  ...
                  className="flex shrink-0 items-center gap-1 px-2 py-0 border border-emerald-200 text-emerald-700 text-[11px] font-medium leading-none rounded-md hover:bg-emerald-50 transition-colors"
                ...
                <button
                  ...
                  className="flex shrink-0 items-center gap-1 px-2 py-0 border border-amber-200 text-amber-800 text-[11px] font-medium leading-none rounded-md hover:bg-amber-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:border-gray-100 disabled:text-gray-400 disabled:hover:bg-transparent"
                  title={
              ...
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-0 border border-red-200 text-red-600 text-[11px] font-medium leading-none rounded-md hover:bg-red-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                title={
                  !canPauseOrStopDuringPlayback
                    ? 'Wait until automatic Clerk sign-in has finished'
                    : 'Stop playback'
              ...
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-0 border border-slate-200 text-slate-700 text-[11px] font-medium leading-none rounded-md hover:bg-slate-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              ...
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-0 border border-indigo-200 text-indigo-800 text-[11px] font-medium leading-none rounded-md hover:bg-indigo-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              ...
              <button
                ...
                className="shrink-0 rounded border border-violet-200 px-2 py-0 text-[11px] font-medium leading-none text-violet-800 hover:bg-violet-50 disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Go
              </button>
              <button
                ...
                className="flex shrink-0 items-center gap-1 px-2 py-0 border border-gray-200 text-gray-600 text-[11px] font-medium leading-none rounded-md hover:border-[#4B90FF] hover:text-[#4B90FF] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
          ...
          <div
            className="flex min-h-0 min-w-0 flex-1 flex-wrap items-center gap-x-2 gap-y-1 self-stretch rounded-lg border border-gray-100 bg-white px-2 py-1.5 shadow-sm lg:flex-nowrap lg:items-center lg:gap-x-2 lg:overflow-x-auto lg:max-w-none lg:flex-none lg:shrink-0"
            role="group"
          ...
          >
            {(
              ...
              <span key={label} className="inline-flex shrink-0 items-baseline gap-1">
                {i > 0 && (
