    ...
    <div className="flex-1 min-h-0 w-full max-w-none overflow-y-auto py-8 px-6 lg:px-10">
      ...
      <div className="space-y-2 mb-6">
        <div className="flex flex-col gap-2 lg:flex-row lg:items-stretch lg:gap-3">
          <div className="flex min-h-0 min-w-0 flex-1 flex-col justify-center self-stretch rounded-lg border border-gray-100 bg-white px-2 py-1.5 shadow-sm lg:min-w-[min(100%,30rem)] lg:flex-[1.2]">
          ...
          <div
            className="flex min-h-0 min-w-0 flex-1 flex-wrap items-center gap-x-2 gap-y-1 self-stretch rounded-lg border border-gray-100 bg-white px-2 py-1.5 shadow-sm lg:max-w-[min(100%,23rem)] lg:flex-none lg:shrink-0"
            role="group"
