...
- AI Visual ID is run-scoped (tests and history attach to the run), but its recording UI belongs in the Add AI prompt step drawer after the earlier numbered sections, not only in the outer recording rail.
